{% assign dimensions = vars.microsoft_advertising.models.microsoft__ad_report.dimensions %}
{% assign metrics = vars.microsoft_advertising.models.microsoft__ad_report.metrics %}
{% assign account_id = vars.microsoft_advertising.account_ids %}
{% assign active = vars.microsoft_advertising.active %}
{% assign table_active = vars.microsoft_advertising.models.microsoft__ad_report.active %}
{% assign dataset_id = vars.output_dataset_id %}
{% assign table_id = vars.microsoft_advertising.models.microsoft__ad_report.table_id %}
...
{% assign source_table_id = 'ad_performance_report' %}
...
{% if active and table_active %}
    AS(
        ...
        sync_info as (
            select
              max(current_date()) as max_synced_at
